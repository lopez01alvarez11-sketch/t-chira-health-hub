  ...
  head: () => ({
    meta: [
      ...
      { title: "Urológico Hospital Clínico | San Cristóbal, Táchira" },
      {
        name: "description",
        content:
          "Hospital clínico privado en San Cristóbal, Táchira: urología, cirugía de mínima invasión, maternidad y emergencias 24/7.",
      },
      { name: "author", content: "Urológico Hospital Clínico C.A." },
